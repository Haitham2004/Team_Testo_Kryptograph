...
namespace KryptographBibliothek
{
    public class ZeichenErsetzen
    {
        public static void Ersetzen()
        {
            ...
            tabelle_zeichen_deutsch.Add("E", 0.1693);
            tabelle_zeichen_deutsch.Add("F", 0.0149);
            tabelle_zeichen_deutsch.Add("G", 0.0302);
            tabelle_zeichen_deutsch.Add("H", 0.0498);
            tabelle_zeichen_deutsch.Add("I", 0.0802);
            tabelle_zeichen_deutsch.Add("J", 0.0024);
            tabelle_zeichen_deutsch.Add("K", 0.0132);
            ...
            tabelle_zeichen_deutsch.Add("Z", 0.0121);
            ...
            tabelle_zeichen_englisch.Add("B", 0.0154);
            tabelle_zeichen_englisch.Add("C", 0.0273);
            tabelle_zeichen_englisch.Add("D", 0.0414);
            tabelle_zeichen_englisch.Add("E", 0.1260);
            ...
            tabelle_zeichen_englisch.Add("P", 0.0166);
            tabelle_zeichen_englisch.Add("Q", 0.0009);
            tabelle_zeichen_englisch.Add("R", 0.0568);
            ...
            tabelle_zeichen_englisch.Add("W", 0.0234);
